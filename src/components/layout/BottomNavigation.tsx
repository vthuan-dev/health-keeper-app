          ...
          if (item.isCenter) {
            return (
              <button
                ...
                className="relative -mt-5 flex items-center justify-center w-12 h-12 rounded-full gradient-primary shadow-health transition-transform hover:scale-105 active:scale-95"
