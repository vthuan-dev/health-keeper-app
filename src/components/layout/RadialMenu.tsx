...
export const allMenuItems: QuickMenuItem[] = [
  ...
  { id: "blood-pressure", icon: "IconHeartbeat", label: "Huyết áp", path: "/health-metrics?tab=blood-pressure&add=true", color: "text-rose-500", bgColor: "bg-rose-500", gradient: "from-rose-400 to-pink-600" },
  { id: "heart-rate", icon: "IconActivityHeartbeat", label: "Nhịp tim", path: "/health-metrics?tab=heart-rate&add=true", color: "text-sky-500", bgColor: "bg-sky-500", gradient: "from-sky-400 to-blue-600" },
  ...
  { id: "meal", icon: "IconToolsKitchen2", label: "Bữa ăn", path: "/nutrition?add=true", color: "text-emerald-500", bgColor: "bg-emerald-500", gradient: "from-lime-400 to-green-600" },
  { id: "activity", icon: "IconBarbell", label: "Hoạt động", path: "/activities?add=true", color: "text-violet-500", bgColor: "bg-violet-500", gradient: "from-violet-400 to-purple-600" },
  ...
  { id: "appointment", icon: "IconCalendarHeart", label: "Lịch khám", path: "/appointments?add=true", color: "text-orange-500", bgColor: "bg-orange-500", gradient: "from-orange-400 to-red-600" },
];
