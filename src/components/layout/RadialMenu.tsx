...
export const allMenuItems: QuickMenuItem[] = [
  { id: "weight", icon: "IconWeight", label: "Cân nặng", path: "/health-metrics?tab=weight&add=true", color: "text-primary", bgColor: "bg-primary", gradient: "from-emerald-400 to-teal-600" },
  { id: "blood-pressure", icon: "IconHeartRateMonitor", label: "Huyết áp", path: "/health-metrics?tab=blood-pressure&add=true", color: "text-rose-500", bgColor: "bg-rose-500", gradient: "from-rose-400 to-pink-600" },
  { id: "heart-rate", icon: "IconWaveSine", label: "Nhịp tim", path: "/health-metrics?tab=heart-rate&add=true", color: "text-sky-500", bgColor: "bg-sky-500", gradient: "from-sky-400 to-blue-600" },
  { id: "blood-sugar", icon: "IconDropletFilled", label: "Đường huyết", path: "/health-metrics?tab=blood-sugar&add=true", color: "text-amber-500", bgColor: "bg-amber-500", gradient: "from-amber-400 to-orange-600" },
  { id: "meal", icon: "IconSoup", label: "Bữa ăn", path: "/nutrition?add=true", color: "text-emerald-500", bgColor: "bg-emerald-500", gradient: "from-lime-400 to-green-600" },
  { id: "activity", icon: "IconRun", label: "Hoạt động", path: "/activities?add=true", color: "text-violet-500", bgColor: "bg-violet-500", gradient: "from-violet-400 to-purple-600" },
  { id: "medicine", icon: "IconPillFilled", label: "Nhắc thuốc", path: "/reminders?add=true", color: "text-cyan-500", bgColor: "bg-cyan-500", gradient: "from-cyan-400 to-teal-600" },
